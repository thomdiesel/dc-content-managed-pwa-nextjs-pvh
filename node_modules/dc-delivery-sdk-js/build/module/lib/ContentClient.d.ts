...
export declare class ContentClient {
     ...
     */
    getContentItem<T extends ContentBody = DefaultContentBody>(contentItemId: string): Promise<ContentItem<T>>;
    /**
     ...
     */
    renderContentItem(contentItemId: string, templateName: string, customParameters?: {
        [id: string]: string;
